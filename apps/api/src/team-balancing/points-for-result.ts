 ...
 * entraînements" page) and StatsService (the average per session is the trainingLevel that
 * splits the training teams) so both read the exact same scoring rule. */
