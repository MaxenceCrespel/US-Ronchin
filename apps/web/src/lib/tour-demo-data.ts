...
export function buildTourDemoData(currentUser: User): DemoEntry[] {
  ...
  const playerStats: PlayerStats[] = [
    { userId: me.id, firstName: me.firstName, lastName: me.lastName, matchesPlayed: 9, goals: 6, ownGoals: 0, assists: 3, yellowCards: 1, redCards: 0, trainingsPresent: 12, trainingsResponded: 13, trainingAttendanceRate: 0.92, averageRating: 6.8, ratingsCount: 9, motmCount: 2, patronDefenseCount: 0, presenceStreak: 11, defensiveMatchesStarted: 0, cleanSheets: 0, goalsConceded: 0, skillScore: 68 },
    { userId: fabien.id, firstName: fabien.firstName, lastName: fabien.lastName, matchesPlayed: 10, goals: 9, ownGoals: 0, assists: 2, yellowCards: 2, redCards: 0, trainingsPresent: 14, trainingsResponded: 14, trainingAttendanceRate: 1, averageRating: 7.1, ratingsCount: 10, motmCount: 3, patronDefenseCount: 1, presenceStreak: 14, defensiveMatchesStarted: 0, cleanSheets: 0, goalsConceded: 0, skillScore: 74 },
    { userId: vincent.id, firstName: vincent.firstName, lastName: vincent.lastName, matchesPlayed: 8, goals: 2, ownGoals: 0, assists: 8, yellowCards: 0, redCards: 0, trainingsPresent: 11, trainingsResponded: 12, trainingAttendanceRate: 0.92, averageRating: 6.5, ratingsCount: 8, motmCount: 1, patronDefenseCount: 2, presenceStreak: 3, defensiveMatchesStarted: 0, cleanSheets: 0, goalsConceded: 0, skillScore: 62 },
    { userId: mehdi.id, firstName: mehdi.firstName, lastName: mehdi.lastName, matchesPlayed: 6, goals: 0, ownGoals: 0, assists: 1, yellowCards: 1, redCards: 0, trainingsPresent: 9, trainingsResponded: 11, trainingAttendanceRate: 0.82, averageRating: 5.9, ratingsCount: 6, motmCount: 0, patronDefenseCount: 0, presenceStreak: 0, defensiveMatchesStarted: 0, cleanSheets: 0, goalsConceded: 0, skillScore: 51 },
    { userId: yann.id, firstName: yann.firstName, lastName: yann.lastName, matchesPlayed: 10, goals: 4, ownGoals: 0, assists: 5, yellowCards: 0, redCards: 0, trainingsPresent: 13, trainingsResponded: 13, trainingAttendanceRate: 1, averageRating: 7.4, ratingsCount: 10, motmCount: 4, patronDefenseCount: 0, presenceStreak: 13, defensiveMatchesStarted: 0, cleanSheets: 0, goalsConceded: 0, skillScore: 79 },
  ]
